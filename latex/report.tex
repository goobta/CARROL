...
\author{
	...
	\IEEEauthorblockA{
		\IEEEauthorrefmark{1}ageuredjian@wpi.edu}

	\IEEEauthorblockA{
		\IEEEauthorrefmark{2}agupta@wpi.edu} 

	\IEEEauthorblockA{
		\IEEEauthorrefmark{3}rmahajan@wpi.edu}

	\IEEEauthorblockA{
		\IEEEauthorrefmark{4}ashaji@wpi.edu}
}
...
Luis Kulczyk for letting us borrow his GTX 1080 for training
